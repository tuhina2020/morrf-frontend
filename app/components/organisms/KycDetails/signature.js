...
debugger;
const Signature = ({ signature, onAdd, onPreviewImage, onEdit, viewOnly }) => {
          ...
          <div className="D(f) Ai(c) Jc(fs) Ff($ffopensans) Fz($md)">
            <div className="W($full)">
              <div className="D(f) Fxd(r) Jc(fs)">
                <div className="Fz($md) My($xms)">UPLOAD SIGNATURE</div>
        ...
        <div className="D(f) Ai(c) Jc(fs) Ff($ffopensans) Fz($md)">
          <div className="W($full)">
            ...
            <div className="D(f) Fxd(c) Flw(w) Jc(fs)">
              <SignatureScroll files={files} onPreviewImage={onPreviewImage} />
            </div>
          </div>
        </div>
      </DisplayCard>
